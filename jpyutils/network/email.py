...
class SMTPClient(object):
    ...
    def send(self, to_addrs, subject, content, attachments=None, content_type='plain'):
        """Send an email.

        Parameters
        ----------
        to_addrs: list or str
            A list of receive emails. Format as: [(name1, email1), (name2, email2), ...]
        ...
        attachments: list
            A list of attachments.  Every attachment have an ID equal to list index,
