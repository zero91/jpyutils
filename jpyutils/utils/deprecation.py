"""
This code is borrowed from scikit-learn:
...
class deprecated(object):
    ...
    >>> from jpyutils.utils import deprecated
    >>> deprecated() # doctest: +ELLIPSIS
    <jpyutils.utils.deprecation.deprecated object at ...>
    ...
    def _update_doc(self, olddoc):
        newdoc = "DEPRECATED"
        if self._m_extra:
            newdoc = "%s: %s" % (newdoc, self._m_extra)
        if olddoc:
            newdoc = "%s\n\n%s" % (newdoc, olddoc)
        return newdoc
